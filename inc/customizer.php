...
function material_theme_wp_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			...
			'render_callback' => 'material_theme_wp_customize_partial_blogname',
		) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector'        => '.site-description',
			'render_callback' => 'material_theme_wp_customize_partial_blogdescription',
		) );
	}
}
add_action( 'customize_register', 'material_theme_wp_customize_register' );
...
add_action( 'customize_preview_init', 'material_theme_wp_customize_preview_js' );
